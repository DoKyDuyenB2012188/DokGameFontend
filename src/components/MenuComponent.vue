    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li>
        <select
          ...
          @change="handleChange"
        >
          <option class="nav-link collapsed" selected value="init">
  ...
  methods: {
    changeBase() {
      ...
      if (baseArr.length == 1) {
        ...
        base +=
          baseArr[baseArr.length - 1].label +
          "=" +
          baseArr[baseArr.length - 1].value;
      }
      if (base != "") {
